...
from pynps.configuration.constants import (
    DEFAULT_DATABASE_FOLDER,
    DEFAULT_DOWNLOAD_FOLDER,
    DEFAULT_PKG2ZIP_PATH,
    DEFAULT_WGET_PATH,
    PS3_AVATARS_DEFAULT_URL,
    PS3_DEMOS_DEFAULT_URL,
    PS3_DLCS_DEFAULT_URL,
    PS3_GAMES_DEFAULT_URL,
    PS3_THEMES_DEFAULT_URL,
    PSM_GAMES_DEFAULT_URL,
    PSP_DLCS_DEFAULT_URL,
    PSP_GAMES_DEFAULT_URL,
    PSP_THEMES_DEFAULT_URL,
    PSP_UPDATES_DEFAULT_URL,
    PSV_DEMOS_DEFAULT_URL,
    PSV_DLCS_DEFAULT_URL,
    PSV_GAMES_DEFAULT_URL,
    PSV_THEMES_DEFAULT_URL,
    PSV_UPDATES_DEFAULT_URL,
    PSX_GAMES_DEFAULT_URL,
)
